...
export const DarkModeToggle = () => {
  ...
  return (
    <div className={style.container}>
      <input type="checkbox" id="darkmode-toggle" onChange={handleChange} checked={isDark}/>
      <label htmlFor="darkmode-toggle">
        <svg className={style.sun} width="800px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <svg className={style.moon} width="800px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
